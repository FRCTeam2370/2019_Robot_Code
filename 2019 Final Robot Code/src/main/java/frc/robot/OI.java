...
import frc.robot.commands.ActuateHatchManipulator;
...
public class OI {
  ...
  public OI(){
    A.whenPressed(new ActuateHatchManipulator());// Open and Close hatch manipulator
    B.whenPressed(new ElevatorToBottom());// Send Elevator to bottom
