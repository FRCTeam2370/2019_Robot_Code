 ...
 *
 */
public class Autogroup2 extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	requires(Robot.hookLifterSubsystem);
    	requires(Robot.shooter);
    	requires(Robot.winchSubsystem);
    	
    	// Drives Backwards
    	addSequential(new Drive(-0.5, -0.5,  4.0));    	
    	addSequential(new WaitUntilCommand(4.0));
